...
{{--<div class="row mx-5 px-5">
    <form action="{{ route('addTest') }}">
        @csrf
        <lable>hy</lable>
        <input type="text" name="test[hy]" class="form-control">
        <lable>ru</lable>
        <input type="text" name="test[ru]" class="form-control">
        <lable>en</lable>
        <input type="text" name="test[en]" class="form-control">
        <input type="submit" >
