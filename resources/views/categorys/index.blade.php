            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
                        <div class="results">Showing <span>{{ $cat->product->count() }}</span> results</div>
                        ...
                        @foreach($products as $product)
                            ...
                            <div class="product mx-auto">
                                ...
                                <div class="product_content">
                                    <div class="product_title"><a href="{{ route('showProduct', ['product', $product->id]) }}">{{ $product->name }}</a></div>
...
@section('custom_js')
    ...
    <script>
            $(".product_sorting_btn").click(function(){
                ...
                $('.sorting_text').text(orderBy)
                $.ajax({
                    url: "{{ route('showCategory',$cat->id) }}",
                    type: "GET",
                    data: {
                      orderBy: orderBy,
